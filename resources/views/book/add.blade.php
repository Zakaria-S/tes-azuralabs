@extends('../layouts.app')
@section('title', 'Library - Add new book')
...
<div class="row w-100 d-flex justify-content-center">
    <form method="POST" action="{{url('/book/add')}}" enctype="multipart/form-data" class="mt-4 d-flex flex-column w-75 justify-content-center align-items-center">
        @csrf
        <h4>Add new book</h4>
        ...
        <div class="w-100 mb-3">
            ...
            <input type="text" name="author" class="form-control" placeholder="Author of the book">
            @error('author')
            <div class="form-text text-danger">{{$message}}</div>
            @enderror
        </div>
        <div class="w-100 mb-3">
            ...
            <input type="text" name="publisher"" class="form-control" placeholder="Publisher of the book">
            @error('publisher')
            <div class="form-text text-danger">{{$message}}</div>
            @enderror
        </div>
        ...
        <div class="w-100 mb-3">
            <img src="" id="preview" class="img-thumbnail" alt="">
        </div>
        <div class="w-100">
